  ...
  return (
    <div className="pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-primary hover:text-primary/80 transition-colors mb-8 no-underline font-medium text-sm"
        >
        ...
        <div className="prose prose-neutral max-w-none space-y-6 text-secondary leading-relaxed text-[15px]">
          <p className="text-sm text-outline">
            Ultima actualizacion: marzo 2026
          </p>

          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">1. Introduccion</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">2. Informacion que recopilamos</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">3. Uso de la informacion</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">4. Privacidad de los ninos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">5. Almacenamiento y seguridad</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">6. Servicios de terceros</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">7. Derechos del usuario</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">8. Cambios en esta politica</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mt-8 mb-3">9. Contacto</h2>
            <p>
